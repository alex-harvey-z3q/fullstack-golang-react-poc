...
func (ec *executionContext) _Query_tasks(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*Task)
	fc.Result = res
	return ec.marshalNTask2ᚕᚖgithubᚗcomᚋalexᚑharveyᚑz3qᚋfullstackᚑgolangᚑreactᚑpocᚋservicesᚋtasksᚋgraphᚐTaskᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Task_done(ctx context.Context, field graphql.CollectedField, obj *Task) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Task_done(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) marshalNTask2ᚕᚖgithubᚗcomᚋalexᚑharveyᚑz3qᚋfullstackᚑgolangᚑreactᚑpocᚋservicesᚋtasksᚋgraphᚐTaskᚄ(ctx context.Context, sel ast.SelectionSet, v []*Task) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNTask2ᚖgithubᚗcomᚋalexᚑharveyᚑz3qᚋfullstackᚑgolangᚑreactᚑpocᚋservicesᚋtasksᚋgraphᚐTask(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNTask2ᚖgithubᚗcomᚋalexᚑharveyᚑz3qᚋfullstackᚑgolangᚑreactᚑpocᚋservicesᚋtasksᚋgraphᚐTask(ctx context.Context, sel ast.SelectionSet, v *Task) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
